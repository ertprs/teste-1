...
export class CompComercialHomeComponent implements OnInit {
  ...
  public dadosDash : any = new Array<{leads:0,negociando:0,ganhamos:0,perdemos:0}>()
  public itens = [1,2,3,4];

  public pedidosList = new Array<Pedidos>();
