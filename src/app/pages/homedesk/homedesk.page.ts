...
export class HomedeskPage implements OnInit {
  ...
  private resolveComponentsName(componentName) {
    ...
    else if(componentName === 'confemail')
    {
      return ConfemailComponent
    }
    else if (componentName === 'compcasosreldetalhe')
    {
      return CompcasosreldetalheComponent
    }
    else if(componentName === 'financeiroOpen')
    {
      return FinanceiroHomeComponent
    }
    else if(componentName === 'compfinview')
    {
      return CompfinviewComponent
    }
    else if(componentName === 'compchatcontatoedit')
    {
      return CompchatcontatoeditPage
    }
    else if(componentName === 'compparceiroadd')
    {
      return CompparceiroaddComponent
    }
    else if(componentName === 'compchatlistadd')
    {
      return CompchatlistaddComponent
    }
    else if(componentName === 'comchatlisthome')
    {
      return ComchatlisthomeComponent
    }
    else if(componentName === 'compconfigempresaedit')
    {
      return CompconfigempresaeditComponent
    }
    else if(componentName === 'compfinrecorrenciahome')
    {
      return CompfinrecorrenciahomeComponent
    }
