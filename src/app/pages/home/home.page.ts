      ...
      .then(res=>{
        ...
        if (this.eventEmitterService.subsVar==undefined) {  
          ...
          invokeFirstComponentFunction.subscribe((param:any) => {  
            ...
            else if(param.function == 'compwpptemplate')
            {
              this.abrirComponente(param.function,data)
            }
            else if(param.function == 'compticketadd')
            {
              this.abrirComponente(param.function,data)
            }
            else if(param.function == 'compdevlog')
            {
              this.abrirComponente(param.function,data)
            }
            else if(param.function == 'compmssgautomatica')
            {
              this.abrirComponente(param.function,data)
            }
            else if(param.function == 'compatendimentorelatoriooperaaco')
            {
              this.abrirComponente(param.function,data)
            }
            else if(param.function == 'compConfigGeral')
            {
              this.abrirComponente(param.function,data)
            }
            else
