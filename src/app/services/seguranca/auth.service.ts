  ...
  checkPermissao(componenteNome:string):Promise<any>
  {
    return new Promise((resolve, reject) => {
      ...
      if(
        ...
        componenteNome.toLowerCase() === 'compchatcontatoedit' ||
      ...
      else
      {
        ...
        if(
          ...
          componenteNome.toLowerCase() === 'compchatlistadd' ||
          componenteNome.toLowerCase() === 'comchatlisthome'
          )
        {
          ...
          //PERMISSOES PARA FINANCEIRO
          componenteNome.toLowerCase() === 'financeiroOpen' ||
          componenteNome.toLowerCase() === 'compfinview' ||
          componenteNome.toLowerCase() === 'compfinrecorrenciahome'
        )
        {
          if(permissaoUser.financeiro )
          {
              liberar = true;
          }
          else
          ...
          )
        {
          ...
          componenteNome.toLowerCase() === 'compparceirosadd'
          )
        {
        ...
        //CONFIGURACOES
          ...
          componenteNome.toLowerCase() === 'confemail' ||
          componenteNome.toLowerCase() === 'compconfigempresaedit'
        )
        {
